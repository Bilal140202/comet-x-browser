...
class SettingsActivity : AppCompatActivity() {
    ...
    private val providers: Map<String, OpenAICompatibleProvider> by lazy {
        mapOf(
            ...
            // v2.2.0: NVIDIA NIM (same verified config as the Compose Cloud AI center)
    ...
    private fun buildUi() {
        ...
        // v2.2.0: the Compose / Material 3 Cloud AI center (new UI, same settings)
        val cloudAiBtn = actionButton("Open Cloud AI center (new Material 3 UI)", Tonal.TONAL)
        root.addView(cloudAiBtn, LinearLayout.LayoutParams(ViewGroup.LayoutParams.MATCH_PARENT, ViewGroup.LayoutParams.WRAP_CONTENT))
        cloudAiBtn.setOnClickListener {
            startActivity(android.content.Intent(this, com.cometx.browser.ui.cloud.CloudAiActivity::class.java))
        }
